...
## Current Progress
Currently trying to reach a goal of 10k labelled messages to train a scoring assistant model that will quickly and more consistently label data for a message labelling model.
